...
> 一个基于 Rust 开发的 JDK 版本管理工具，帮助您在 Windows 上轻松安装、切换和管理多个 JDK 版本。

Java-Mocha 是一个基于 Foojay API 开发的 Java 版本管理工具，支持通过命令行界面进行 JDK 版本管理，也可通过 API 集成使用。

> 目前仅适配 Oracle 和 Oracle OpenJDK，需要支持更多JDK厂商或者有其他改进可以提issue
...
更多详细信息请查看 [开发文档](DEVELOP_DOC_zh.md)。
